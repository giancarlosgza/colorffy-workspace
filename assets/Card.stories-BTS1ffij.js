import{_ as r}from"./Card-R0DDmk63.js";import"./iframe-DPImpSJt.js";import"./preload-helper-C1FmrZbK.js";const U={title:"Components/Card",component:r,tags:["autodocs"],argTypes:{variant:{control:"select",options:["default","pane","elevated"]}}},t={render:n=>({components:{UiCard:r},setup(){return{args:n}},template:`
      <UiCard v-bind="args">
        <template #body>
          <h3>Card Title</h3>
