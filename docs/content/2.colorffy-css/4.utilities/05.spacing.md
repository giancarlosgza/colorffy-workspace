...
::note
Since 2.5, component-internal spacing uses the `--space-*` design tokens
(`--space-4` … `--space-48`, number = px). The utility classes below keep
their own historical scale until 3.0 — see the
