...
declare const __VLS_component: import('vue').DefineComponent<import('../../../types/button').IBaseButtonProps, {}, {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {} & {
    onClick: () => any;
}, string, import('vue').PublicProps, Readonly<import('../../../types/button').IBaseButtonProps> & Readonly<{
