declare type DialogClassName = string | string[] | Record<string, boolean>
declare type DialogMode = 'modal' | 'side-sheet' | 'headless'
declare type DialogSize = 'sm' | 'md' | 'lg'
declare type DialogVariant = 'danger' | 'warning' | 'success' | 'primary'
...
declare interface IDialogDisplay {
  /**
