...
declare const meta: {
    title: string;
    component: import('vue').DefineComponent<import('../../..').ITabsProps, {}, {}, {}, {}, import('vue').ComponentOptionsMixin, import('vue').ComponentOptionsMixin, {}, string, import('vue').PublicProps, Readonly<import('../../..').ITabsProps> & Readonly<{}>, {
        pillTabs: boolean;
